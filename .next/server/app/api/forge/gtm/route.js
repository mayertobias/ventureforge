...
Generate a comprehensive, execution-ready GTM strategy now. Return ONLY the JSON object.`;async function C(a){try{let b,c=await (0,v.getServerSession)(w.N);if(!c?.user?.email)return u.NextResponse.json({error:"Unauthorized"},{status:401});let{projectId:d}=await a.json();if(!d)return u.NextResponse.json({error:"Project ID is required"},{status:400});let e=await x.z.user.findUnique({where:{email:c.user.email}});if(!e)return u.NextResponse.json({error:"User not found"},{status:404});if(e.credits<10)return u.NextResponse.json({error:"Insufficient credits",required:10,current:e.credits},{status:402});let f=await x.z.project.findFirst({where:{id:d,userId:e.id}});if(!f)return u.NextResponse.json({error:"Project not found"},{status:404});if(!f.pitchOutput)return u.NextResponse.json({error:"Investor pitch must be completed before GTM strategy"},{status:400});let g=f.ideaOutput?await z.P.decryptUserData(e.id,f.ideaOutput):null,h=f.researchOutput?await z.P.decryptUserData(e.id,f.researchOutput):null,i=f.blueprintOutput?await z.P.decryptUserData(e.id,f.blueprintOutput):null,j=f.financialOutput?await z.P.decryptUserData(e.id,f.financialOutput):null,k=await z.P.decryptUserData(e.id,f.pitchOutput),l={businessIdea:g?.selectedIdea?.title||"Business concept",targetMarket:h?.targetCustomerAnalysis?.primarySegment||"Target market analysis",valueProposition:i?.executiveSummary?.businessConcept||i?.valueProposition?.core||"Value proposition analysis",revenueModel:i?.coreBusinessModel?.primaryModel||"Revenue model analysis",fundingNeeds:j?.fundingAnalysis?.seedFunding||"$1,500,000",targetCustomers:k?.marketOpportunity?.targetCustomer||h?.targetCustomerAnalysis?.primarySegment||"Target customer analysis",financialProjections:{year1Revenue:j?.threeYearProjections?.year1?.totalRevenue||"$500,000",year2Revenue:j?.threeYearProjections?.year2?.totalRevenue||"$1,200,000",year3Revenue:j?.threeYearProjections?.year3?.totalRevenue||"$2,800,000",monthlyBurnRate:j?.fundingAnalysis?.monthlyBurnRate?.year1Average||"$75,000",customerCAC:j?.keyMetrics?.cac||"$500",customerLTV:j?.keyMetrics?.ltv||"$2,400",averageARPU:j?.revenueModel?.revenueStreams?.[0]?.pricingStrategy||"$200/month"},keyAssumptions:{customerGrowthRate:"25% monthly growth target",marketPenetration:"0.1% of TAM by Year 3",avgDealSize:j?.keyMetrics?.paybackPeriod||"12 months",conversionRate:"2.5% website to demo, 15% demo to close"}};console.log(`[GTM] Starting GTM strategy generation for project ${d}`);let m=B.replace("{full_business_plan}",JSON.stringify(l)),n=`Create a 6-month go-to-market strategy for: ${l.businessIdea}. 
    
    CRITICAL: Based on the financial projections (Year 1 Revenue: ${l.financialProjections.year1Revenue}, CAC: ${l.financialProjections.customerCAC}, LTV: ${l.financialProjections.customerLTV}), calculate specific monthly revenue targets that build toward the Year 1 goal.
    
    Target Customer: ${l.targetCustomers}
    Value Proposition: ${l.valueProposition}
    
    You must provide concrete numbers for all metrics - NO placeholders or TBD values allowed.`,o=await y.U.generateWithRetry({prompt:m,userPrompt:n,retryConfig:{maxRetries:3,timeoutMs:24e4,backoffMs:3e3}});if(o.successful){console.log(`[GTM] AI generation successful after ${o.retryCount} retries`);let a=y.U.parseJSONResponse(o.content);a.success?b=a.parsed:(console.warn(`[GTM] JSON parsing failed: ${a.error}`),(b=y.U.createFallbackResponse("gtm",m))._originalResponse=o.content.substring(0,500))}else console.error(`[GTM] AI generation failed after ${o.retryCount} retries`),(b=y.U.createFallbackResponse("gtm",m))._retryCount=o.retryCount;let p=await z.P.encryptUserData(e.id,b);return await x.z.$transaction([x.z.project.update({where:{id:d},data:{gtmOutput:p,updatedAt:new Date}}),x.z.user.update({where:{id:e.id},data:{credits:e.credits-10}})]),u.NextResponse.json({success:!0,result:b,creditsUsed:10,creditsRemaining:e.credits-10})}catch(a){return console.error("Error in GTM:",a),u.NextResponse.json({error:"Internal server error"},{status:500})}}let D=new e.AppRouteRouteModule({definition:{kind:f.RouteKind.APP_ROUTE,page:"/api/forge/gtm/route",pathname:"/api/forge/gtm",filename:"route",bundlePath:"app/api/forge/gtm/route"},distDir:".next",projectDir:"",resolvedPagePath:"/Users/manojveluchuri/saas/venture-forge/src/app/api/forge/gtm/route.ts",nextConfigOutput:"",userland:d}),{workAsyncStorage:E,workUnitAsyncStorage:F,serverHooks:G}=D;function H(){return(0,g.patchFetch)({workAsyncStorage:E,workUnitAsyncStorage:F})}async function I(a,b,c){var d;let e="/api/forge/gtm/route";"/index"===e&&(e="/");let g=await D.prepare(a,b,{srcPage:e,multiZoneDraftMode:"false"});if(!g)return b.statusCode=400,b.end("Bad Request"),null==c.waitUntil||c.waitUntil.call(c,Promise.resolve()),null;let{buildId:u,params:v,nextConfig:w,isDraftMode:x,prerenderManifest:y,routerServerContext:z,isOnDemandRevalidate:A,revalidateOnlyGenerated:B,resolvedPathname:C}=g,E=(0,j.normalizeAppPath)(e),F=!!(y.dynamicRoutes[E]||y.routes[C]);if(F&&!x){let a=!!y.routes[C],b=y.dynamicRoutes[E];if(b&&!1===b.fallback&&!a)throw new s.NoFallbackError}let G=null;!F||D.isDev||x||(G="/index"===(G=C)?"/":G);let H=!0===D.isDev||!F,I=F&&!H,J=a.method||"GET",K=(0,i.getTracer)(),L=K.getActiveScopeSpan(),M={params:v,prerenderManifest:y,renderOpts:{experimental:{dynamicIO:!!w.experimental.dynamicIO,authInterrupts:!!w.experimental.authInterrupts},supportsDynamicResponse:H,incrementalCache:(0,h.getRequestMeta)(a,"incrementalCache"),cacheLifeProfiles:null==(d=w.experimental)?void 0:d.cacheLife,isRevalidate:I,waitUntil:c.waitUntil,onClose:a=>{b.on("close",a)},onAfterTaskError:void 0,onInstrumentationRequestError:(b,c,d)=>D.onRequestError(a,b,d,z)},sharedContext:{buildId:u}},N=new k.NodeNextRequest(a),O=new k.NodeNextResponse(b),P=l.NextRequestAdapter.fromNodeNextRequest(N,(0,l.signalFromNodeResponse)(b));try{let d=async c=>D.handle(P,M).finally(()=>{if(!c)return;c.setAttributes({"http.status_code":b.statusCode,"next.rsc":!1});let d=K.getRootSpanAttributes();if(!d)return;if(d.get("next.span_type")!==m.BaseServerSpan.handleRequest)return void console.warn(`Unexpected root span type '${d.get("next.span_type")}'. Please report this Next.js issue https://github.com/vercel/next.js`);let e=d.get("next.route");if(e){let a=`${J} ${e}`;c.setAttributes({"next.route":e,"http.route":e,"next.span_name":a}),c.updateName(a)}else c.updateName(`${J} ${a.url}`)}),g=async g=>{var i,j;let k=async({previousCacheEntry:f})=>{try{if(!(0,h.getRequestMeta)(a,"minimalMode")&&A&&B&&!f)return b.statusCode=404,b.setHeader("x-nextjs-cache","REVALIDATED"),b.end("This page could not be found"),null;let e=await d(g);a.fetchMetrics=M.renderOpts.fetchMetrics;let i=M.renderOpts.pendingWaitUntil;i&&c.waitUntil&&(c.waitUntil(i),i=void 0);let j=M.renderOpts.collectedTags;if(!F)return await (0,o.I)(N,O,e,M.renderOpts.pendingWaitUntil),null;{let a=await e.blob(),b=(0,p.toNodeOutgoingHttpHeaders)(e.headers);j&&(b[r.NEXT_CACHE_TAGS_HEADER]=j),!b["content-type"]&&a.type&&(b["content-type"]=a.type);let c=void 0!==M.renderOpts.collectedRevalidate&&!(M.renderOpts.collectedRevalidate>=r.INFINITE_CACHE)&&M.renderOpts.collectedRevalidate,d=void 0===M.renderOpts.collectedExpire||M.renderOpts.collectedExpire>=r.INFINITE_CACHE?void 0:M.renderOpts.collectedExpire;return{value:{kind:t.CachedRouteKind.APP_ROUTE,status:e.status,body:Buffer.from(await a.arrayBuffer()),headers:b},cacheControl:{revalidate:c,expire:d}}}}catch(b){throw(null==f?void 0:f.isStale)&&await D.onRequestError(a,b,{routerKind:"App Router",routePath:e,routeType:"route",revalidateReason:(0,n.c)({isRevalidate:I,isOnDemandRevalidate:A})},z),b}},l=await D.handleResponse({req:a,nextConfig:w,cacheKey:G,routeKind:f.RouteKind.APP_ROUTE,isFallback:!1,prerenderManifest:y,isRoutePPREnabled:!1,isOnDemandRevalidate:A,revalidateOnlyGenerated:B,responseGenerator:k,waitUntil:c.waitUntil});if(!F)return null;if((null==l||null==(i=l.value)?void 0:i.kind)!==t.CachedRouteKind.APP_ROUTE)throw Object.defineProperty(Error(`Invariant: app-route received invalid cache entry ${null==l||null==(j=l.value)?void 0:j.kind}`),"__NEXT_ERROR_CODE",{value:"E701",enumerable:!1,configurable:!0});(0,h.getRequestMeta)(a,"minimalMode")||b.setHeader("x-nextjs-cache",A?"REVALIDATED":l.isMiss?"MISS":l.isStale?"STALE":"HIT"),x&&b.setHeader("Cache-Control","private, no-cache, no-store, max-age=0, must-revalidate");let m=(0,p.fromNodeOutgoingHttpHeaders)(l.value.headers);return(0,h.getRequestMeta)(a,"minimalMode")&&F||m.delete(r.NEXT_CACHE_TAGS_HEADER),!l.cacheControl||b.getHeader("Cache-Control")||m.get("Cache-Control")||m.set("Cache-Control",(0,q.getCacheControlHeader)(l.cacheControl)),await (0,o.I)(N,O,new Response(l.value.body,{headers:m,status:l.value.status||200})),null};L?await g(L):await K.withPropagatedContext(a.headers,()=>K.trace(m.BaseServerSpan.handleRequest,{spanName:`${J} ${a.url}`,kind:i.SpanKind.SERVER,attributes:{"http.method":J,"http.target":a.url}},g))}catch(b){if(L||await D.onRequestError(a,b,{routerKind:"App Router",routePath:E,routeType:"route",revalidateReason:(0,n.c)({isRevalidate:I,isOnDemandRevalidate:A})}),F)throw b;return await (0,o.I)(N,O,new Response(null,{status:500})),null}}},81630:a=>{a.exports=require("http")},83997:a=>{a.exports=require("tty")},86439:a=>{a.exports=require("next/dist/shared/lib/no-fallback-error.external")},91645:a=>{a.exports=require("net")},94735:a=>{a.exports=require("events")},96330:a=>{a.exports=require("@prisma/client")}};var b=require("../../../../webpack-runtime.js");b.C(a);var c=b.X(0,[602,446,190,248,449,756],()=>b(b.s=80821));module.exports=c})();